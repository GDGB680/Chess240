...
public class GameService {
    ...
    public void joinGame(int gameID, String playerColor, String authToken) throws DataAccessException {
        ...
        // Validate game ID
        if (gameID <= 0) {throw new DataAccessException("bad request");}
    ...
    private GameData assignPlayerToGame(GameData gameData, String username, String color)
        ...
        if (color.equalsIgnoreCase("WHITE")) {
            if (gameData.whiteUsername() != null) {throw new DataAccessException("already taken");}
            return new GameData(
                    gameData.gameID(),
                    username,
            ...
            if (gameData.blackUsername() != null) {throw new DataAccessException("already taken");}
            return new GameData(
                    gameData.gameID(),
